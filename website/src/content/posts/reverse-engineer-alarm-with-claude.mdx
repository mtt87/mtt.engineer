...
<Image alt="alarm apk decompiled" src={alarmApk} class="max-w-75 border border-gray-300" />
...
Surprisingly Gemini was able to find an issue with the type of AES encryption and I was able to move past the authentication point and make it work 🎉
...
<Image alt="Home Assistant Lovelace card" src={haLovelaceCard} class="max-w-100" />
