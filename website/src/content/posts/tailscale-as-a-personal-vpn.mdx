...
<Image
  loading="eager"
  class="mx-auto block max-w-100 border border-gray-300"
  alt="add device menu"
  src={tailscaleAddDevice}
/>
...
<Image
  ...
  alt="exit node device"
  src={tailscaleExitNode}
/>
